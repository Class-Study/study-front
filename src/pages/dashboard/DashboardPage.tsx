        ...
        return (
            <div className={styles.page}>
                ...
                <nav className={styles.tabs}>
                    <button
                        className={`${styles.tab} ${activeTab === 'calendario' ? styles.active : ''}`}
                    ...
                    <div className={styles.inner}>
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className={styles.cardHeader}>
                                                    <div
                                                        className={`${styles.cardAvatar} ${styles[getAvatarToneClass(student.name)]}`}>
                      ...
                      <span className={`${styles.levelTag} ${styles[levelClass]}`}>
                        {levelName}
                                                    ...
                                                    <span
                                                        className={`${styles.statusBadge} ${student.status === 'ACTIVE' ? styles.statusActive : styles.statusBlocked}`}>
                        {student.status === 'ACTIVE' ? '● Ativo' : '⊘ Bloqueado'}
                                                ...
                                                <div className={styles.progressSection}>
                                                    <div className={styles.progressLabel}>
                                                        Duração
                                                        <span
                                                            className={styles.progressPercent}>{student.classDuration}min</span>
                                                    </div>
