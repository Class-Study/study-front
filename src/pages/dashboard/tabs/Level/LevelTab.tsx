  ...
  return (
    <>
      ...
      <ManagementModal
        ...
        creatingSubfolder={state.creatingSubfolder}
        handleCreateSubfolder={state.handleCreateSubfolder}
        editingSubfolderId={state.editingSubfolderId}
        setEditingSubfolderId={state.setEditingSubfolderId}
        editingSubfolderName={state.editingSubfolderName}
        setEditingSubfolderName={state.setEditingSubfolderName}
      ...
      <PreviewModal
        ...
        setIsPropagateModalOpen={state.setIsPropagateModalOpen}
        setPendingMaterials={state.setPendingMaterials}
      />

      <PropagateModal
        isPropagateModalOpen={state.isPropagateModalOpen}
        savingTemplate={state.savingTemplate}
        setIsPropagateModalOpen={state.setIsPropagateModalOpen}
