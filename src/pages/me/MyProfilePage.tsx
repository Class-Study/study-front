...
import { StudentScheduleTab } from '@/pages/me/tabs/StudentScheduleTab';
import { StudentBillingTab } from '@/pages/me/tabs/StudentBillingTab';
import styles from './MyProfilePage.module.css';

type TabType = 'perfil' | 'cronograma' | 'financeiro';
  ...
  return (
    <div className={styles.page}>
      ...
      <nav className={styles.tabs}>
        ...
        <button
          className={`${styles.tab} ${activeTab === 'financeiro' ? styles.active : ''}`}
          onClick={() => setActiveTab('financeiro')}
        >
          💳 Financeiro
        </button>
        <button
          className={`${styles.tab} ${activeTab === 'cronograma' ? styles.active : ''}`}
