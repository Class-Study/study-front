...
import {StudentExerciseFolder} from '@/types/studentProfile.types.ts';
                ...
                {!isPreviewOpen ? (
                    <>
                        <div className={styles.headerCopy}>
                            ...
                            <p className={styles.subtitle}>Faça upload do .docx, ajuste os metadados e visualize o
                                resultado da conversão antes de criar.</p>
                        </div>
